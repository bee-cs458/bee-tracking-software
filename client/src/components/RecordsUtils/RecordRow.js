  ...
  return (
    <>
      ...
      >
        ...
        {props.variant === "light" ?
        expanded ? <td><img src={arrow} className="upsidedown"></img></td> : <td><img src={arrow} ></img></td>
        : expanded ? <td><img src={arrow} className="upsidedown darkModeArrow"></img></td> : <td><img src={arrow} className="darkModeArrow"></img></td>}
