...
router.post("/update_password", requireBody('password', 'newPassword'), updateUserPassword);
...
router.post("/editUser/:oldId", restrictTo("owner"), requireBody('user_id', 'first_name', 'last_name', 'strikes', 'updatePass'), editUser);
router.post("/editUserProfile/:userId", requireBody('first_name', 'last_name'), editUserProfile)
